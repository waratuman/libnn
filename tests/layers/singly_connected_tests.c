...
{
    nn_layer_singly_connected_t* l = nn_layer_create_singly_connected(linear_activation, 2);
...
char* test_nn_layer_integrate_singly_connected()
{
    nn_layer_singly_connected_t* l;
    
    l = nn_layer_create_singly_connected(linear_activation, 2);
    l->weights[0] = 1.0;
    l->weights[1] = 1.0;
...
char *all_tests() {
    ...
    mu_run_test(test_nn_layer_integrate_singly_connected);
