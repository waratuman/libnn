...
{
    nn_layer_fully_connected_t* l = nn_layer_create_fully_connected(linear_activation, sum_of_products_integration, 1, 1);
...
char* test_nn_layer_integrate_fully_connected()
{
    nn_layer_fully_connected_t* l;
    
    l = nn_layer_create_fully_connected(linear_activation, sum_of_products_integration, 2, 1);
    l->weights[0][0] = 1.0;
    l->weights[0][1] = 1.0;
...
char *all_tests() {
    ...
    mu_run_test(test_nn_layer_integrate_fully_connected);
